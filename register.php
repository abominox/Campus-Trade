			...
			if ($password == $repeatpassword)
			{
				...
				else
				{
					...
					else
					{
						//open db
						$hostname = "localhost";
						$dbloginusername = "test";
						$dbloginpassword = "test";
						...
						die("You have successfully registered for Campus List! <a href='index.php'>Return to main page.</a>");
					}
				}
			}
			else
