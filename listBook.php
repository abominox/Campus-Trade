...
<link rel="stylesheet" href="phptestCSS.css">
</head>
<body>
...
// upload image
	if ($uploadOK == 0) {
		...
		if (move_uploaded_file($_FILES["file"]["tmp_name"], $target_dir . $new_name)) {
			...
			$sql = "INSERT INTO books (listingTitle, bookTitle, ISBN, class, price, email, phone, contact,image)
							VALUES ('$_POST[post_listing]', '$_POST[post_title]', '$_POST[post_isbn]',
							'$_POST[post_subject]', '$_POST[post_price]', '$_POST[post_email]',
							'$_POST[post_phone]', '$_POST[post_name]', '$new_name')";
